...
**🎯 Highlights:**
- ⚡ Vertical Tunnel FET (VTFET) design
- 🔬 Synopsys Sentaurus TCAD simulation
- 📊 Pocket-engineering optimization
- 🧪 Device physics characterization
- 📈 Performance analysis & modeling

**Tech Stack:**
`TCAD` `Device Modeling` `Batchfile` `Sentaurus` `Semiconductor Physics`
...
- 🎛️ Portable instrumentation

**Tech Stack:**
`Embedded C` `STM32` `ADC` `DMA` `TFT Display` `Real-time Systems`
...
**Wide-swing high-gain analog design**

**🎯 Highlights:**
- 🎚️ MOSFET cascode architecture
- 📈 High-gain differential amplifier
- 🔧 LTspice simulation & analysis
- ⚡ Wide output swing optimization
- 🔬 Small-signal analysis
- 🧪 Hardware implementation

**Tech Stack:**
`Analog Design` `LTspice` `MOSFET` `Circuit Analysis` `Amplifier Design`
...
always @(posedge clk) begin
  if (challenge_detected)
    solution <= analyze() & design() & implement() & optimize();
  else
    learning <= learning + 1;
end
```
...
**✨ Passion drives precision. Innovation powers progress. Engineering creates impact.**
